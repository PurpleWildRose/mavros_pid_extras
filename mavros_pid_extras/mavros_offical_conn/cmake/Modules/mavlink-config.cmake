...
set(mavlink_INCLUDE_DIRS "${CMAKE_CURRENT_SOURCE_DIR}/utils")
set(mavlink_DIALECTS common;standard)
set(mavlink2_DIALECTS common;standard)
...
foreach(lib )
  ...
  find_library(onelib ${lib}
      PATHS "/home/cxy/catkin_ws/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
